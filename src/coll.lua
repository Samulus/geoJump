--[[  ____            ___    ___                                              
  ...
  function colUpdate(hero, col)
    ...
    if x > 799 or y > 599 or x < 0 or y < 0 then return "black" end
    
    local r,g,b,a = map.col:getPixel(x,y)
    ...
    if b == 0   and g == 0   and b == 255 then return "blue"   end
  end
    ...
    if bottom == "red"    then hero.dead = true end
    
    if forwd == "green"  or back == "green"  then col.nDoor = true end
    if forwd == "yellow" or back == "yellow" then col.pDoor = true end
    if forwd  == "white" and back == "white" then col.pDoor = false; col.nDoor = false end
  end
